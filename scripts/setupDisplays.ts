...
module SetupDisplays {
    ...
    myModule.directive('mdInclude', ['Showdown', function (Showdown) {
        return {
            restrict: 'AE',
            link: function (scope, element, attrs) {
                ...
                if (mdFilesCache.hasOwnProperty(fileName)) {
                    ...
                    $.get('/mdfiles/' + fileName + ".md.html", null,
    ...
    myModule.directive('specsInclude', ['loader', function (loader) {
        return {
            restrict: 'AE',
            link: function (scope, element, attrs) {
    ...
    var RegisterSection = function (sectionName: string, items: IDisplayItemMeta[]) {
        ...
        Globals.RegisterSection(sectionName, function ($routeProvider, $locationProvider) {
            ...
            $routeProvider.when(rootAction + ':itemName/:tab?', {
                    ...
                    controller: ['$scope', '$routeParams', '$filter', '$location', 'titleSetter', 'activeSection', function ($scope, $routeParams, $filter, $location, titleSetter, activeSection) {
                        ...
                        controller: ['$scope', 'titleSetter', 'activeSection', function ($scope, titleSetter, activeSection) {
